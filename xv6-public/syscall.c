...
extern int sys_set_bjf_params_for_process(void);
extern int sys_set_bjf_params_for_system(void);
...
extern int sys_print_syscall_count(void);
...
static int (*syscalls[])(void) = {
    ...
    [SYS_set_bjf_params_for_process] sys_set_bjf_params_for_process,
    [SYS_set_bjf_params_for_system] sys_set_bjf_params_for_system,
    ...
    [SYS_print_syscall_count] sys_print_syscall_count,
